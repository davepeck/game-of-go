...
var GameBoardView = Class.create({
    ...
    {
        var point = $(this._point_id(x, y));
        point.src = "/static/game/img/highlight.png";
    },
    ...
    _point_src : function(x, y)
    {
        if (this.board.is_speculation(x, y))
        {
            ...
            {
                return "/static/game/img/ghost-black.png";
            }
            else if (b == CONST.White_Color)
            {
                return "/static/game/img/ghost-white.png";
            }          
        }
        else
        {
            ...
            if (o == CONST.Black_Color)
            {
                if (this.board.get_point(x, y) == CONST.White_Color)
                    return "/static/game/img/dead-white.png";
                else
                    return "/static/game/img/territory-black.png";
            }
            else if (o == CONST.White_Color)
            {
                if (this.board.get_point(x, y) == CONST.Black_Color)
                    return "/static/game/img/dead-black.png";
                else
                    return "/static/game/img/territory-white.png";
            }
        }

        return "/static/game/img/transparent-1x1.png";
    },
